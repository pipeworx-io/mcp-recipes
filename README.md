...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/search_meals \
  -H 'Content-Type: application/json' \
  -d '{"query":"pasta"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/search_meals`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
